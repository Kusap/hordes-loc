export default {
  ...
  description: {
    ...
    ru: 'Орда Bloodlust ценит свободу и лояльность, оставляя место для индивидуализма или даже хаоса. Их укрепления находится в пустынном месте, названном Headless Landing.',
