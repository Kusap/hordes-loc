...
},
{
  ...
  description: {
    ...
    ru: 'Режет врага, нанося удар с дополнительной силой. Исцеляет вас на 5% от нанесенного урона.',
...
},
{
  ...
  description: {
    ...
    ru: 'Увеличьте шанс блока, одновременно повышая урон после каждого успешного блока.',
...
},
{
  ...
  description: {
    ...
    ru: 'Быстро взмахните мечом вокруг себя, нанеся урон врагам вокруг.',
...
},
{
  ...
  description: {
    ...
    ru: 'Стреляет ракетой льда в сторону врага. Уменьшает время перезарядки Icicle Orb на 0,5 секунды. Замораживает цель до 5 стаков, при которых она будут оглушена и будет получать на 50% увеличенный урон. Получает одно мгновенное заклинание каждые 7 секунд.',
...
},
{
  ...
  description: {
    ...
    ru: 'Исцелить дружелюбную цель. Количество увеличивается за каждый стак Revtialize.',
...
},
{
  ...
  description: {
    ...
    ru: 'Исцелить дружелюбную цель в течение короткого времени, складывается до 3 раз, при этом увеличивает силу Mend.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы унаследовали особые способности благодаря своим предкам и семейным традициям, что предоставляет вам дополнительные преимущества от определенных характеристик.',
...
},
{
  ...
  description: {
    ...
    ru: 'Тщательно прицельный выстрел с высоким уроном. Увеличивает урон от следующих выстрелов Swift Shot и позволяет стрелять ими мгновенно.',
...
},
{
  ...
  description: {
    ...
    ru: 'Ваш Precise Shots будут перепрыгивать на дополнительные цели.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы и члены вашей пати быстро восстанавливаете ману в течение некоторого времени.',
...
},
{
  ...
  description: {
    ...
    ru: 'Выпустите ледяную ударную волну вокруг вас, нанося периодический урон и замораживая врагов. Увеличивает шанс критического удара для некоторымх из ваших заклинаний.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вызывите большой шар, выпускиющий сосульки и наносящий урон всем врагам на своем пути.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы получаете Haste и весь ваш исходящий урон увеличивается. Сбрасывает перезарядку Icicle Orb.',
...
},
{
  ...
  description: {
    ...
    ru: 'Ваш Crescent Swipe рвет врагов, заставляя их истекать кровью и нанося дополнительный урон. Складывается до 3-х раз.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы и члены вашей пати наносите дополнительный урон.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы и члены вашей пати получаете дополнительную защиту.',
...
},
{
  ...
  description: {
    ...
    ru: 'Пассивно увеличивет вашу защиту.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы и члены вашей пати получаете дополнительный Крит %',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы и члены вашей пати получаете дополнительный Haste.',
...
},
{
  ...
  description: {
    ...
    ru: 'Пассивно увеличивает ваш Крит %.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы и члены вашей пати получаете дополнительную скорость передвижения',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы и члены вашей пати получаете значительно больше Haste, что позволяет вам атаковать быстрее.',
...
},
{
  ...
  description: {
    ...
    ru: 'Ваш Precise Shot наносит ядовитый дебафф при попадании, нанося урон и замедляя врагов.',
...
},
{
  ...
  description: {
    ...
    ru: 'Расположите тотем на земле, который исцеляет всю вашу пати.',
...
},
{
  ...
  description: {
    ...
    ru: 'Выстрелите Swift Shot, который можно усилить, выстрелив перед этим Precise Shot.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы стягиваете врагов вокруг к вам на короткое время. Прерывает произнесение заклинаний и сбрасывает агрессию для всех монстров.',
...
},
{
  ...
  description: {
    ...
    ru: 'Призовите членов своей пати, позволяя им мгновенно телепортироваться к вам.',
...
},
{
  ...
  description: {
    ...
    ru: 'Превратитесь в ваше духовное животное для дополнительной Скорости Передвижения. Сбрасывает все замедляющие эффекты, которые были до трансформации. Любое заклинание отменит этот эффект.',
...
},
{
  ...
  description: {
    ...
    ru: 'Превращает вашу цель в зомби, прерывая все действия, замедляя его и уменьшая получаемое им исцеление на время.',
...
},
{
  ...
  description: {
    ...
    ru: 'Вы делаете рывок в вашем текущем направлении, мгновенно сбросив перезарядку Precise Shot. Ваш следующий Precise Shot - мгновенный.',
...
},
{
  ...
  description: {
    ...
    ru: 'Позволяет вам оседлать Mounts (ездовых животных). Mounts привязаны к вашему аккаунту',
...
},
{
  ...
  description: {
    ...
    ru: 'Телепортируйтесь к Conjurer (на базу текищей локации)',
